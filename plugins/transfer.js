...
let handler = async (m, { conn, args, usedPrefix, DevMode }) => {
    if (args.length < 3) {
        ...
        switch (type) {
            case 'money':
                if (global.DATABASE.data.users[m.sender].money >= count * 1) {
                    try {
                        global.DATABASE.data.users[m.sender].money -= count * 1
                        global.DATABASE.data.users[who].money += count * 1
            ...
            case 'potion':
                if (global.DATABASE.data.users[m.sender].potion >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].potion += count * 1
            ...
            case 'sampah':
                if (global.DATABASE.data.users[m.sender].sampah >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].sampah += count * 1
            ...
            case 'diamond':
                if (global.DATABASE.data.users[m.sender].diamond >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].diamond += count * 1
            ...
            case 'common':
                if (global.DATABASE.data.users[m.sender].common >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].common += count * 1
            ...
            case 'uncommon':
                if (global.DATABASE.data.users[m.sender].uncommon >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].uncommon += count * 1
            ...
            case 'mythic':
                if (global.DATABASE.data.users[m.sender].mythic >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].mythic += count * 1
            ...
            case 'legendary':
                if (global.DATABASE.data.users[m.sender].legendary >= count * 1) {
                    try {
                        ...
                        global.DATABASE.data.users[who].legendary += count * 1
