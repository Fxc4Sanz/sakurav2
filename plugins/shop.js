...
let handler  = async (m, { conn, command, args, usedPrefix, DevMode }) => {
    ...
    const armor = (_armor == 0 ? 20000 : '' || _armor == 1 ? 49999 : '' || _armor == 2 ? 99999 : '' || _armor == 3 ? 149999 : '' || _armor == 4 ? 299999 : '' || _armor == 5 ? 399999 : '' || _armor == 6 ? 499999 : '' || _armor == 7 ? 599999 : '' || _armor == 8 ? 699999 : '')
        ...
        if (/shop|toko/i.test(command)) {
            ...
            case 'buy':
                switch (_type) {
                    ...
                    break
                    case 'armor':
                            if (global.DATABASE.data.users[m.sender].armor == 8) return conn.reply(m.chat, 'Armormu sudah *Level Max*', m)
