...
`.trim(), '', 'DISABLE DELETE', '#off antidelete', {
    ...
    async onCall(json) {
        ...
        await this.sendMessage(from, 'Bot Tidak Menerima Panggilan. Maaf Anda akan diblokir, silakan hubungi pemilik bot ini untuk membuka blokir ini wa.me/62895603352610', MessageType.extendedText)
